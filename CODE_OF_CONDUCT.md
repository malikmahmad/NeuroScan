...
We as members, contributors, and maintainers pledge to make participation in the NeuroScan project — its GitHub repository, issues, pull requests, and discussions — a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
- Focusing on what is best for the project and the community, not just one's own preference
...
This Code of Conduct applies within all project spaces — the GitHub repository, issue tracker, pull requests, and discussions — and also applies when an individual is officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainer at **malik.mahmadahmad@gmail.com**. All complaints will be reviewed and investigated promptly and fairly.
