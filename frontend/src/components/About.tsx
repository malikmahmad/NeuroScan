...
const HIGHLIGHTS = [
  { label: "95.44%", desc: "ResNet-50 test accuracy (best model)" },
  { label: "0.886", desc: "U-Net Dice score on LGG MRI dataset" },
  { label: "7 + 1", desc: "Architectures compared (CNN, EfficientNet, ResNet-50, DenseNet-121, MobileNetV3, Swin-T, ViT) + U-Net" },
...
const STACK = [
  ...
  { name: "Canvas API",    desc: "Network visualisation" },
    ...
    <section id="about" className="about">
      <div ref={headerRef} className={`about__header reveal ${headerVisible ? "is-visible" : ""}`}>
        ...
        <p className="about__lead">
          ...
          NeuroScan trains seven architecturally different models under identical conditions — same
      ...
      >
        <div className="about__text">
          ...
          <p>
            ...
            models (CNN, EfficientNet-B0, ResNet-50, DenseNet-121, MobileNetV3), where it is
            mathematically valid. Swin-T and ViT-B/16 receive Attention Rollout instead —
            aggregating self-attention weights across all encoder layers — because applying
            Grad-CAM to a pure transformer is a methodological error that several public
          ...
          <p>
            ...
            All models are served live through a FastAPI backend with no stored predictions —
