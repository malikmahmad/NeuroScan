...
const FEATURES = [
  {
    ...
    title: "7-Model Classification",
    tag: "Core",
    desc: "CNN, EfficientNet-B0, ResNet-50, DenseNet-121, MobileNetV3, Swin-T, and ViT-B/16 — all trained on identical splits under identical conditions. Architecture is the only variable.",
    highlight: "95.3% best accuracy",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    ...
    tag: "Analysis",
    desc: "In compare mode, probabilities from all 7 models are averaged into a single ensemble verdict — more robust than any single architecture alone.",
