  ...
  return (
    <section id="top" className="hero">
      ...
      >
        ...
        <h1>
          See what <span className="hero__accent">seven</span> different<br />
          neural architectures<br />
          <span className="hero__accent">see in a brain scan.</span>
        </h1>
        <p className="hero__subhead">
          NeuroScan classifies brain tumor MRI scans with CNN, EfficientNet-B0, ResNet-50,
          DenseNet-121, MobileNetV3, Swin-T, and ViT-B/16 — all under identical conditions.
          Segments tumors with U-Net. Explains predictions with Grad-CAM and Attention Rollout.
        </p>
