...
const STEPS = [
  ...
  {
    n: "02", title: "Seven models classify it",
    desc: "CNN, EfficientNet-B0, ResNet-50, DenseNet-121, MobileNetV3, Swin-T, and ViT-B/16 each independently predict the tumor type.",
