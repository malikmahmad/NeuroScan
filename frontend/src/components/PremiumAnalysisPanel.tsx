    ...
    <div className="premium-panel" aria-hidden>
      <div className="panel-wrap">
        ...
        <div className="badges">
          ...
          <div className="badge b2">EfficientNet</div>
          <div className="badge b3">ResNet-50</div>
          <div className="badge b4">ViT-B/16</div>
          <div className="badge b5">Swin-T</div>
          <div className="badge b6">U-Net</div>
        </div>
      </div>
      ...
      <style>{`
        ...
        .b1 { left:-28px; top:10px;  transform: translateY(0); animation: float1 6s   ease-in-out infinite; }
        .b2 { right:-12px; top:36px; transform: translateY(0); animation: float2 5.5s ease-in-out infinite; }
        .b3 { left: -10px; top:50%;  transform: translateY(-50%); animation: float3 7s   ease-in-out infinite; }
        .b4 { right:-30px; top:50%;  transform: translateY(-50%); animation: float4 5.8s ease-in-out infinite; }
        .b5 { left: -28px; bottom:18px; transform: translateY(0); animation: float1 6.5s ease-in-out infinite; }
        .b6 { right:-12px; bottom:10px; transform: translateY(0); animation: float2 5.2s ease-in-out infinite; }
