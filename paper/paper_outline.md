...
U-Net (Ronneberger et al., 2015) remains the standard architecture for medical image segmentation [13]. Applied to the LGG MRI Segmentation dataset, published Dice scores range from 0.84 to 0.92 depending on training protocol and evaluation split [14]. This work achieves Dice 0.886 on a held-out test set of 589 slices.
